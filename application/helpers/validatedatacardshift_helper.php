<?php
    ...
    */
    ...
    /**
     * Functionality: (เอกสารเบิกบัตร) ฟังก์ชั่นเช็คประเภทการเบิกบัตร เบิกปกติ เบิกอัตโนมัติ
     * Parameters: Array เงื่อนไขการเช็คค่า [tSessionID]
     * Creator: 29/09/2022 IcePHP
     * Last Modified:
     * Return: 
     * Return Type: Numeric
    */
    function FSnHCrdShiftChkCtyStaShift($paParams){
        $ci = &get_instance();
        $ci->load->database();
        ...
        $tSessionID     = $paParams['tSessionID'];
        $tSeqNo         = $paParams['tSeqNo'];
        $nCtyStaShift   = $paParams['nCtyStaShift'];
        ...
        // StatusActive = 1: เบิกปกติ , 2:เบิกอัตโนมัติ 
                $tErrorStaCrdActive  = "";
        switch ($nCtyStaShift) {
            case '1':
                //Status Active
                $tWhereCrdStaActive  = " AND CTY.FTCtyStaShift = '1'";
                $tErrorStaCrdActive  = language('document/card/docvalidate','tErrorCtyStaShiftAuto'); // Add document validate (Ice) 29/08/2022
                break;
            case '2':
                //Status InActives
                $tWhereCrdStaActive  = " AND CTY.FTCtyStaShift = '2'";
                $tErrorStaCrdActive  = language('document/card/docvalidate','tErrorCtyStaShiftDefault'); // Add document validate (Ice) 29/08/2022
                break;
            default:
                $tWhereCrdStaActive  =  "";
        }
