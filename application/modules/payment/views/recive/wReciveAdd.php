                            ...
                            <div class="row">
                                ...
                                <div class="form-group">
                                    <div class="validate-input">
                                        ...
                                        <input type="number" class="form-control" maxlength="50" id="oetRCVNumCopyReceipt" name="oetRCVNumCopyReceipt" placeholder="<?= language('payment/recive/recive', 'tRCVNumCopyReceipt') ?>" autocomplete="off" value="<?php echo $tRcvQtySlip;?>" >
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="validate-input">
                                        ...
                                        <input type="text" class="form-control" maxlength="30" id="oetRcvExtRefCode" name="oetRcvExtRefCode" placeholder="<?= language('payment/recive/recive', 'tRCVExtRefCode') ?>" autocomplete="off" value="<?php echo $tRcvRefExt;?>" >
                                    </div>
                                </div>
