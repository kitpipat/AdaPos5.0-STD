    ...
    <div class="row">
        ...
        <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
            ...
            <div class="form-group">
                ...
                <textarea class="form-group" rows="4" maxlength="50" id="oetCrdlogRemark" name="oetCrdlogRemark" autocomplete="off"   placeholder="<?php echo language('payment/cardlogin/cardlogin','tCrdLRemark')?>"><?php echo $tRemark;?></textarea>
            </div>
