...
<table class="table table-hover">
  <thead>
    <tr>
      ...
      <th class="text-center"><?= language('monitor/monitor/monitor','tMONLowtableThCol2')?></th>
      <th class="text-center"><?= language('monitor/monitor/monitor','tMONLowtableThCol3')?></th>
      <th class="text-center"><?= language('monitor/monitor/monitor','tMONLowtableThCol4')?></th>
      <th class="text-center"><?= language('monitor/monitor/monitor','tMONLowtableThCol5')?></th>
      <th class="text-center"><?= language('monitor/monitor/monitor','tMONLowtableThCol7')?></th>
      <th class="text-center"><?= language('monitor/monitor/monitor','tMONLowtableThCol8')?></th>
      <th class="text-center"><?= language('monitor/monitor/monitor','tMONLowtableThCol9')?></th>
      <th class="text-center"><?= language('monitor/monitor/monitor','tMONLowtableThCol10')?></th>
      <th class="text-center"><?= language('monitor/monitor/monitor','tMONLowtableThCol11')?></th>
      <th class="text-center"><?= language('monitor/monitor/monitor','tMONLowtableThCol12')?></th>
      <th class="text-center"><?= language('monitor/monitor/monitor','tMONLowtableThCol13')?></th>
