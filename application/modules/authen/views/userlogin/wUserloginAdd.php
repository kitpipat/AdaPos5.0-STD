        ...
        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
            ...
            <!-- <div class="col-lg-6 col-md-6 col-xs-6"> -->
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-group" rows="4" maxlength="50" id="oetUsrlogRemark" name="oetUsrlogRemark" autocomplete="off"   placeholder="<?php echo language('authen/user/user','tUSRLRemark')?>"><?php echo $tRemark;?></textarea>
                </div>
