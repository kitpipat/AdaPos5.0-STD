...
-- เพิ่ม รายงานพิเศษ - รายงานยอดขายตามสินค้า ตามกลุ่มธุรกิจ ตามร้านค้า --
IF NOT EXISTS(SELECT FTRptCode FROM TCNSRptSpc WHERE FTRptCode='SPCANI005') BEGIN
    INSERT INTO TCNSRptSpc (FNRptGrpSeq, FTRptGrpCode, FNRptSeq, FTRptCode, FTRptRoute, FTRptFilterCol, FTRptStaActive)
    VALUES (1, 'SPC001', 5, 'SPCANI005', 'rptRptSalByMerShp', '1,6,2,4,13', '1')
END 

IF NOT EXISTS(SELECT FTRptCode FROM TCNSRptSpc_L WHERE  FTRptCode='SPCANI005') BEGIN
    INSERT INTO TCNSRptSpc_L (FTRptCode, FNLngID, FTRptName)
    VALUES ('SPCANI005', 1, 'รายงาน - ยอดขายตามสินค้า ตามกลุ่มธุรกิจ ตามร้านค้า')
END