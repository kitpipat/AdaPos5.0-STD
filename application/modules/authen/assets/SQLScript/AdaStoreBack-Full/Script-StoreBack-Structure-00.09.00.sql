...
IF NOT EXISTS(SELECT COLUMN_NAME FROM INFORMATION_SCHEMA.Columns WHERE TABLE_NAME = 'TCNTImpMasTmp' AND COLUMN_NAME = 'FTVatCode') BEGIN
	ALTER TABLE TCNTImpMasTmp ADD FTVatCode varchar(5)
END
GO
IF NOT EXISTS(SELECT COLUMN_NAME FROM INFORMATION_SCHEMA.Columns WHERE TABLE_NAME = 'TCNTImpMasTmp' AND COLUMN_NAME = 'FTSplStaVATInOrEx') BEGIN
	ALTER TABLE TCNTImpMasTmp ADD FTSplStaVATInOrEx varchar(1)
END
GO
IF NOT EXISTS(SELECT COLUMN_NAME FROM INFORMATION_SCHEMA.Columns WHERE TABLE_NAME = 'TCNTImpMasTmp' AND COLUMN_NAME = 'FTSplCode') BEGIN
	ALTER TABLE TCNTImpMasTmp ADD FTSplCode varchar(20)
END
GO
IF NOT EXISTS(SELECT COLUMN_NAME FROM INFORMATION_SCHEMA.Columns WHERE TABLE_NAME = 'TCNTImpMasTmp' AND COLUMN_NAME = 'FTSplName') BEGIN
	ALTER TABLE TCNTImpMasTmp ADD FTSplName varchar(200)
END
GO
IF NOT EXISTS(SELECT COLUMN_NAME FROM INFORMATION_SCHEMA.Columns WHERE TABLE_NAME = 'TCNTImpMasTmp' AND COLUMN_NAME = 'FNSplCrTerm') BEGIN
	ALTER TABLE TCNTImpMasTmp ADD FNSplCrTerm bigint NULL
END
GO
IF NOT EXISTS(SELECT COLUMN_NAME FROM INFORMATION_SCHEMA.Columns WHERE TABLE_NAME = 'TCNTImpMasTmp' AND COLUMN_NAME = 'FCSplCrLimit') BEGIN
	ALTER TABLE TCNTImpMasTmp ADD FCSplCrLimit [numeric](18, 4) NULL
END
GO

IF NOT EXISTS(SELECT COLUMN_NAME FROM INFORMATION_SCHEMA.Columns WHERE TABLE_NAME = 'TCNMSpl' AND COLUMN_NAME = 'FTFmtCodeExp') BEGIN
	ALTER TABLE TCNMSpl ADD FTFmtCodeExp varchar(5)
END
GO

IF NOT EXISTS(SELECT COLUMN_NAME FROM INFORMATION_SCHEMA.Columns WHERE TABLE_NAME = 'TCNMSpl' AND COLUMN_NAME = 'FTSplStaLocal') BEGIN
	ALTER TABLE TCNMSpl ADD FTSplStaLocal varchar(1)
END
GO


IF NOT EXISTS(SELECT COLUMN_NAME FROM INFORMATION_SCHEMA.Columns WHERE TABLE_NAME = 'TRPTPdtEntryTmp' AND COLUMN_NAME = 'FTPplCode') BEGIN
	ALTER TABLE TRPTPdtEntryTmp ADD FTPplCode varchar(20)
END
GO
...
IF NOT EXISTS(SELECT COLUMN_NAME FROM INFORMATION_SCHEMA.Columns WHERE TABLE_NAME = 'TRPTPdtEntryTmp' AND COLUMN_NAME = 'FTPplName') BEGIN
	ALTER TABLE TRPTPdtEntryTmp ADD FTPplName varchar(200)
END
GO

/* ------------------ Script Structure AdaWallet 00.01.00 --------------------- */

IF NOT EXISTS(SELECT COLUMN_NAME FROM INFORMATION_SCHEMA.Columns WHERE TABLE_NAME = 'TFNMCard' AND COLUMN_NAME = 'FTCrdOTP') BEGIN
	ALTER TABLE TFNMCard ADD FTCrdOTP VARCHAR(10) NOT NULL
END
GO

IF NOT EXISTS(SELECT COLUMN_NAME FROM INFORMATION_SCHEMA.Columns WHERE TABLE_NAME = 'TFNMCard' AND COLUMN_NAME = 'FDCrdOTPExp') BEGIN
	ALTER TABLE TFNMCard ADD FDCrdOTPExp DATETIME NOT NULL
END
GO

ALTER TABLE TFNMCard ALTER COLUMN FTCrdRefID VARCHAR(50)
ALTER TABLE TFNMCard ALTER COLUMN FTCtyCode VARCHAR(50)
ALTER TABLE TFNTCrdImpDT ALTER COLUMN FTCtyCode VARCHAR(50)
ALTER TABLE TFNTCrdImpTmp ALTER COLUMN FTCtyCode VARCHAR(50)

IF NOT EXISTS(SELECT COLUMN_NAME FROM INFORMATION_SCHEMA.Columns WHERE TABLE_NAME = 'TSysEdc' AND COLUMN_NAME = 'FTSedFmt') BEGIN
	ALTER TABLE TSysEdc ADD FTSedFmt VARCHAR(100)
END
GO
