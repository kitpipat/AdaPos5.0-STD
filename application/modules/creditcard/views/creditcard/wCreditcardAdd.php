                ...
                <div class="row">
                    ...
                    <div class="col-xs-8 col-sm-8">
                        ...
                        <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="<?php echo language('creditcard/creditcard/creditcard','tCDCFormat')?>" maxlength="20" id="oetCrdFmt" name="oetCrdFmt" value="<?php echo @$tCrdFmt;?>"> 
                        </div>
