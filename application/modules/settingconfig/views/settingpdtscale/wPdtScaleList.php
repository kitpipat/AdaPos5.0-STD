			...
			<div class="form-group">
				...
				<div class="input-group">
					<input
						...
						id="oetSearchAll"
						name="oetSearchAll"
						onkeypress="Javascript:if(event.keyCode==13) JSvPDSDataTable()"
						placeholder="<?php echo language('customer/customerGroup/customerGroup','tCstGroupSearchData')?>"
					>
					<span class="input-group-btn">
						<button id="oimSearchPDS" class="btn xCNBtnSearch" type="button" onclick="JSvPDSDataTable()">
				...
				<div id="odvMngTableList" class="btn-group xCNDropDrownGroup">
					...
					<ul class="dropdown-menu" role="menu">
						<li id="oliBtnDeleteAll" class="disabled">
							<a href="javascript:;" data-toggle="modal" data-target="#odvModalDelPDS" onclick="JSxPDSSetDataBeforeDelMulti()"><?php echo language('common/main/main','tCMNDeleteAll')?></a>
						</li>
					</ul>
				</div>
			</div>
...
<div class="panel-body">
	<section id="ostDataPDS"></section>
</div>
</div>
</div>
<div class="modal fade" id="odvModalDelPDS">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<input  type="hidden" id="ospCode2"></span>
			...
			<div class="modal-footer">
				<button id="osmConfirm" type="button" class="btn xCNBTNPrimery" onClick="JSnPDSDelChoose()">
