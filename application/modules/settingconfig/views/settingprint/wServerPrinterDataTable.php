            ...
            <table class="table table-striped">
                <thead>
                    <tr>
                        ...
                        <th class="xCNTextBold text-left" style="width:20%;"><?php echo language('product/settingprinter/settingprinter', 'tSPTBCode') ?></th>
                        <th class="xCNTextBold text-left" style="width:20%;"><?php echo language('product/settingprinter/settingprinter', 'tSPTBName') ?></th>
                        <th class="xCNTextBold text-left" style="width:20%;"><?php echo language('product/settingprinter/settingprinter', 'tPRNAgency') ?></th>
                        <th class="xCNTextBold text-left" style="width:10%;"><?php echo language('product/settingprinter/settingprinter', 'tSPTBStatus') ?></th>
                    ...
                    <?php if ($aDataList['rtCode'] == 1) : ?>
                        <?php foreach ($aDataList['raItems'] as $key => $aValue) { ?>
                            <tr class="text-center xCNTextDetail2 otrSrvPri" id="otrSrvPri<?= $key ?>" data-code="<?= $aValue['rtPrnSrvCode'] ?>" data-name="<?= $aValue['rtPrnSrvName'] ?>">
                                ...
                                <td class="text-left otdSrvPriName"><?= $aValue['rtPrnSrvAgnName'] ?></td>
                                <?php
                                $tSrvPriSta = '';
