            ...
            <div class="row">
                <div class="col-xs-12 col-md-5 col-lg-5">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control " maxlength="100" placeholder="<?php echo language('supplier/groupsupplier/groupsupplier', 'tSGPGroupSup') ?>" id="oetSgpName" name="oetSgpName" value="<?= $tSgpName ?>" data-validate-required="<?= language('supplier/groupsupplier/groupsupplier', 'tSGPValidName') ?>"> <!-- เปลี่ยนชื่อ Class เพิ่ม DataValidate -->
                    </div>
