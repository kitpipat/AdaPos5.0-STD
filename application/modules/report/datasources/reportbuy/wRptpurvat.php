                            ...
                            <?php foreach ($aDataReport['aRptData'] as $nKey => $aValue) { ?>
                                ...
                                if ($tGrouppingBch != $tBchCode) {
                                    ...
                                    if ($nRowPartID == 1) {
                                        ...
                                        echo '<tr>';
                                        echo '<td class="xCNRptGrouPing  text-left" colspan="6" style="padding: 5px;">'.$aDataTextRef['tRptTaxSalePosBch'] . '(' . $tBchCode . ') ' .  $tBchName.'</td>';
                                        echo '<td class="xCNRptGrouPing text-right" style="padding: 5px;"></td>';
                                        echo '<td class="xCNRptGrouPing text-right" style="padding: 5px;"></td>';
                                        echo '<td class="xCNRptGrouPing text-right" style="padding: 5px;">'.$nBchXphAmt.'</td>';
                                        echo '<td class="xCNRptGrouPing text-right" style="padding: 5px;">'.$nBchXphVat.'</td>';
                                        echo '<td class="xCNRptGrouPing text-right" style="padding: 5px;">'.$nBchXphAmtNV.'</td>';
                                        echo '<td class="xCNRptGrouPing text-right" style="padding: 5px;">'.$nBchXphGrandTotal.'</td>';
                                        echo '</tr>';
                                    }
                                ...
                                <tr>
                                    ...
                                    <td class="text-center xCNRptDetail"><?php echo substr($aValue['FDXphRefExtDate'], 0, 10); ?></td> 
                                    <td class="text-left xCNRptDetail"><?php echo $aValue['FTXphRefExt']; ?></td>
