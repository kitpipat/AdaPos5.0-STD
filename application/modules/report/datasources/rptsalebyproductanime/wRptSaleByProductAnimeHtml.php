        ...
        <div class="xCNContentReport">
            <div id="odvRptTableAdvance" class="table-responsive">
                <table class="table">
                    <thead>
                        <tr>
                            <th nowrap class="text-left xCNRptColumnHeader" style="width:7%"><?php  echo $aDataTextRef['tRptSaleByProductAnimeBarCode']; ?></th>
                            ...
                            <th nowrap class="text-left xCNRptColumnHeader" ><?php  echo $aDataTextRef['tRptSaleByProductAnimeBrand']; ?></th>
                            <th nowrap class="text-right xCNRptColumnHeader" style="width:10%"><?php  echo $aDataTextRef['tRptQty'] ?></th>
                            <th nowrap class="text-right xCNRptColumnHeader" style="width:5%"><?php  echo $aDataTextRef['tRptSaleByProductAnimeBalance']?></th>
                            <th nowrap class="text-right xCNRptColumnHeader" style="width:5%"><?php   echo $aDataTextRef['tRptSales']; ?></th>
                            <th nowrap class="text-right xCNRptColumnHeader" style="width:5%"><?php   echo $aDataTextRef['tRptSaleByProductAnimeSetPrice']; ?></th>
                    ...
                    <tbody>
                        <?php if(isset($aDataReport['aRptData']) && !empty($aDataReport['aRptData'])):?>
                            ...
                            <?php foreach($aDataReport['aRptData'] as $nKey=>$aValue):?>
                                ...
                                <tr>
                                    <td class="text-left xCNRptDetail"><?php echo '&nbsp;&nbsp;'.$aValue["FTXsdBarCode"];?></td>
                                    <td class="text-left xCNRptDetail">
                                        <?php
                                            echo ($aValue["FTPdtName"] != "" ? $aValue["FTPdtName"] : "-");
                                        ?>
                                    </td>
                                    <td class="text-left xCNRptDetail"><?php echo ($aValue["FTPgpChainName"] != "" ? $aValue["FTPgpChainName"] : "-");?></td>
                                    <td class="text-left xCNRptDetail"><?php echo ($aValue["FTPbnName"] != "" ? $aValue["FTPbnName"] : "-");?></td>
                                    ...
                                    <td class="text-right xCNRptDetail"><?php echo number_format($aValue["FCSdtNetSale"], $nOptDecimalShow);?></td>
                                    <td class="text-right xCNRptDetail"><?php echo number_format($aValue["FCPgdPriceRet"], $nOptDecimalShow);?></td>
                                    <td class="text-right xCNRptDetail"><?php echo number_format($aValue["FCSdtNetAmt"], $nOptDecimalShow);?></td>
                                </tr>

                                <?php
                                    // Step 3 : เตรียม Parameter สำหรับ Summary Sub Footer
                                    $nSumSubXsdQty          = number_format($aValue["FCXsdQtyAll_SubTotal"], $nOptDecimalShow);
                                    $nSumSubStkQty          = number_format($aValue["FCStkQty_SubTotal"], $nOptDecimalShow);
                                    $cSumSubNetSale         = number_format($aValue["FCSdtNetSale_SubTotal"], $nOptDecimalShow);
                                    $cSumSubPriceRet        = number_format($aValue["FCPgdPriceRet_SubTotal"], $nOptDecimalShow);
                                    $cSumSubNetAmt          = number_format($aValue["FCSdtNetAmt_SubTotal"], $nOptDecimalShow);
                                   
                                    $tSumBranch             = $aDataTextRef['tRptTotal'].' '.$aDataTextRef['tRptBranch'].' '.$aValue["FTBchCode"];

                                    $aSumFooter             = array($tSumBranch,'N','N',$nSumSubXsdQty,$nSumSubStkQty,$cSumSubNetSale,$cSumSubPriceRet,$cSumSubNetAmt);
                                    ...
                                    $nSumFootXsdQty             = number_format($aValue["FCXsdQtyAll_Footer"], $nOptDecimalShow);
                                    $nSumFootStkQty             = number_format($aValue["FCStkQty_Footer"], $nOptDecimalShow);
                                    $cSumFootNetSale            = number_format($aValue["FCSdtNetSale_Footer"], $nOptDecimalShow);
                                    $cSumFootPriceRet           = number_format($aValue["FCPgdPriceRet_Footer"], $nOptDecimalShow);
                                    $cSumFootNetAmt             = number_format($aValue["FCSdtNetAmt_Footer"], $nOptDecimalShow);
                                    $paFooterSumData            = array($aDataTextRef['tRptTotalFooter'],'N','N','N',$nSumFootXsdQty,$nSumFootStkQty,$cSumFootNetSale,$cSumFootPriceRet,$cSumFootNetAmt);
                                ?>
                            <?php endforeach;?>
                            <?php
