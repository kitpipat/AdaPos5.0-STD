                ...
                <table class="table">
                    <thead>
                        <tr>
                            ...
                            <th nowrap class="text-left xCNRptColumnHeader"  ><?php echo $aDataTextRef['tFTPbnName']?></th>
                            <th nowrap class="text-left xCNRptColumnHeader"  ><?php echo $aDataTextRef['tFTPdtName']?></th>
                            <th nowrap class="text-left xCNRptColumnHeader"  ><?php echo $aDataTextRef['tFTPdtNameJP']?></th>
                            <th nowrap class="text-left xCNRptColumnHeader"  ><?php echo $aDataTextRef['tRptBarCodeunit']?></th>
                            <th nowrap class="text-right xCNRptColumnHeader"  ><?php echo $aDataTextRef['tRptSbdReTailUnit']?></th>
                            <th nowrap class="text-right xCNRptColumnHeader"  ><?php echo $aDataTextRef['tRptQtyIncomeUnit']?></th>
                            <th nowrap class="text-right xCNRptColumnHeader"  ><?php echo $aDataTextRef['tRptQtySalUnit']?></th>
                            <th nowrap class="text-right xCNRptColumnHeader"  ><?php echo $aDataTextRef['tFCStfOnHandQty']?></th>
                        </tr>
                    ...
                    <tbody>
                        <?php if(isset($aDataReport['aRptData']) && !empty($aDataReport['aRptData'])):?>
                            ...
                            <?php foreach ($aDataReport['aRptData'] as $nKey=>$aValue): ?>
                                ...
                                <tr class="">
                                    <td class="text-left xCNRptDetail" ><?php echo $aValue['FTPtyName'];?></td>
                                    <td class="text-left xCNRptDetail" ><?php echo $aValue["FTPbnName"]; ?></td>
                                    <td class="text-left xCNRptDetail" ><?php echo $aValue['FTPdtName'];?></td>
                                    <td class="text-left xCNRptDetail" ><?php echo $aValue['FTPdtNameOth'];?></td>
                                    <td class="text-left xCNRptDetail" ><?php echo $aValue['FTBarCode'];?></td>
                                    <td class="text-right xCNRptDetail" ><?php echo number_format($aValue["FCPdtStkSetPrice"], $nOptDecimalShow); ?></td>
                                    <td class="text-right xCNRptDetail" ><?php echo number_format($aValue["FCPdtStkQtyIn"], $nOptDecimalShow); ?></td>
                                    <td class="text-right xCNRptDetail" ><?php echo number_format($aValue["FCPdtStkQtySale"], $nOptDecimalShow); ?></td>
                            ...
                            <?php 
                              //เตรียม Parameter สำหรับ SumFooter
                                $cXshAmtNV_Footer             = number_format($aValue["FCPdtStkSetPrice_Footer"], $nOptDecimalShow);
                                $cXshVatable_Footer     = number_format($aValue["FCPdtStkQtyIn_Footer"], $nOptDecimalShow);
                                $cXshVat_Footer             = number_format($aValue["FCPdtStkQtySale_Footer"], $nOptDecimalShow);
                                $cXshGrandAmt_Footer             = number_format($aValue["FCStkQtyBal_Footer"], $nOptDecimalShow);
                                $paFooterSumData            = array($aDataTextRef['tRptTotalFooter'],'N','N','N','N',$cXshAmtNV_Footer,$cXshVatable_Footer,$cXshVat_Footer,$cXshGrandAmt_Footer);
                                endforeach;
                                ?>
                            <?php
                                //Summary Footer
