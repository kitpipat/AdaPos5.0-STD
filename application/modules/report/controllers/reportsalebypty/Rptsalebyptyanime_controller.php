...
class Rptsalebyptyanime_controller extends MX_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->load->model('report/reportsalebypty/Rptsalebyptyanime_model');
    ...
    private function init()
    {
        $this->aText = [
            // Title
            'tTitleReport' => language('report/report/report', 'tRptSalebyPtyTitle'),
            ...
            'tRptSalebyPtyCostTotal'  => language('report/report/report', 'tRptSalebyPtyCostTotal'),//ราคาขายต่อชิ้น
            'tRptSalebyPtySalAmtTotal'  => language('report/report/report', 'tRptSalebyPtySalAmtTotal'),//จำนวนที่รับเข้า(ชิ้น)
            'tRptSalebyPtyBalCostTotal' => language('report/report/report', 'tRptSalebyPtyBalCostTotal'),//จำนวนที่ขาย(ชิ้น)	
            'tRptSalebyPtyBalSalTotal' => language('report/report/report', 'tRptSalebyPtyBalSalTotal'),//ราคาต่อชิ้น
    ...
    public function index()
    {
        ...
        if (!empty($this->tRptExportType) && !empty($this->tRptCode)) {
            ...
            $this->Rptsalebyptyanime_model->FSnMExecStoreReport($this->aRptFilter);
    ...
    public function FSvCCallRptViewBeforePrint($paDataSwitchCase)
    {
        ...
        $aDataReport = $this->Rptsalebyptyanime_model->FSaMGetDataReport($aDataWhereRpt);
        ...
        $tRptView = JCNoHLoadViewAdvanceTable('report/datasources/reportsalebypty', 'wReportsalebyptyHtml', $aDataViewPdt);
    ...
    public function FSoCChkDataReportInTableTemp($paDataSwitchCase)
    {
        try {
            ...
            $nDataCountPage = $this->Rptsalebyptyanime_model->FSnMCountDataReportAll($aDataCountData);
    ...
    public function FSvCCallRptRenderExcel()
    {
        ...
        $aCells = [
            ...
            WriterEntityFactory::createCell($this->aText['tRptSalebyPtyCostTotal']),
            WriterEntityFactory::createCell($this->aText['tRptSalebyPtySalAmtTotal']),
            WriterEntityFactory::createCell($this->aText['tRptSalebyPtyBalCostTotal']),
            WriterEntityFactory::createCell($this->aText['tRptSalebyPtyBalSalTotal'])
        ];
        ...
        if (isset($aDataReport['aRptData']) && !empty($aDataReport['aRptData'])) {
            foreach ($aDataReport['aRptData'] as $nKey => $aValue) {
                ...
                $values = [
                    ...
                    WriterEntityFactory::createCell(null),
                    WriterEntityFactory::createCell(FCNnGetNumeric($aValue["FCXsdCostAvg"])),
                    WriterEntityFactory::createCell(FCNnGetNumeric($aValue["FCXsdSaleTotal"])),
                    WriterEntityFactory::createCell(FCNnGetNumeric($aValue["FCStkCostBal"])),
                    WriterEntityFactory::createCell(FCNnGetNumeric($aValue['FCSalAmtBal']))
                ];
                ...
                if (($nKey + 1) == FCNnHSizeOf($aDataReport['aRptData'])) { //SumFooter
                    ...
                    $cPdtStkSetPrice_Footer    = $aValue["FCXsdCostAvg_Footer"];
                    $cPdtStkQtyIn_Footer       = $aValue["FCXsdSaleTotal_Footer"];
                    $cPdtStkQtySale_Footer     = $aValue["FCStkCostBal_Footer"];
                    $cStkQtyBal_Footer         = $aValue["FCSalAmtBal_Footer"];
                    $values = [
