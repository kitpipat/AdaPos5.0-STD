...
class cRptTopUp extends MX_Controller {
     /**
     * ภาษา
     * @var array
     */
    ...
    public function index() {
        ...
        if (!empty($this->tRptExportType) && !empty($this->tRptCode)) {
            ...
            $this->mRptTopUp->FSnMExecStoreReport($this->aRptFilter);
    ...
    public function FSvCCallRptViewBeforePrint($paDataSwitchCase) {
        ...
        // Get Data Report
        $aDataReport = $this->mRptTopUp->FSaMGetDataReport($aDataWhere, $this->aRptFilter);
    ...
    public function FSvCCallRptViewBeforePrintClickPage() {
        ...
        $aDataReport = $this->mRptTopUp->FSaMGetDataReport($aDataWhere, $aDataFilter);
    ...
    public function FCNvCRenderKoolReportHtml($paDataReport, $paDataFilter) {
        ...
        if($aDataReport['rnCurrentPage'] == $aDataReport['rnAllPage']){ 
            ...
            $aSumDataReport = $this->mRptTopUp->FSaMRPTCRDGetDataRptTopUpSum($aDataWhere);
        }
    ...
    public function FSoCChkDataReportInTableTemp($paDataSwitchCase) {
        ...
        try {
            ...
            $nDataCountPage = $this->mRptTopUp->FSaMCountDataReportAll($aDataCountData);
    ...
    public function  FSvCCallRptRenderExcel(){
        ...
        $aCells = [
            WriterEntityFactory::createCell($this->aText['tRPC14TBCardCode']),
            WriterEntityFactory::createCell($this->aText['tRPC14TBCardTypeName']),
            WriterEntityFactory::createCell($this->aText['tRPC14TBCardHolderID']),
            WriterEntityFactory::createCell($this->aText['tRPC14TBCardName']),
            WriterEntityFactory::createCell($this->aText['tRPC14TBDptName']),
            WriterEntityFactory::createCell($this->aText['tRPC14TBCardTxnDocNoRef']),
            WriterEntityFactory::createCell($this->aText['tRPC14TBCardUsrName']),
            WriterEntityFactory::createCell($this->aText['tRPC14TBCardTxnDocDate']),
            WriterEntityFactory::createCell($this->aText['tRPC14TBCardStaActive']),
            WriterEntityFactory::createCell($this->aText['tRPC14TBCardTxnCrdValue']),
            WriterEntityFactory::createCell($this->aText['tRPC14TBCardTxnValue']),
            WriterEntityFactory::createCell($this->aText['tRPC14TBCardTxnValAftTrans']),
        ];
        ...
        if(isset($aDataReport['raItems']) && !empty($aDataReport['raItems'])) {
            foreach ($aDataReport['raItems'] as $nKey => $aValue) {
                ...
                switch($aValue['FTCrdStaActive']){
                    case '1':
                        $tCrdStaActive = $this->aText['tRPC14CardDetailStaActive1'];
                    break;
                    case '2':
                       $tCrdStaActive = $this->aText['tRPC14CardDetailStaActive2'];
                    break;
                    case '3':
                       $tCrdStaActive = $this->aText['tRPC14CardDetailStaActive3'];
                    break;
                    default:
                       $tCrdStaActive = $this->aText['tRPC14CardDetailStaActive'];
                }
                $tRPC14TBCardTypeName = explode(";",$aValue['FTCtyName']);
                $aExplodeCrdHolderID = explode(";",$aValue['FTCrdHolderID']);
                $tRPC14TBDptName = explode(";",$aValue['FTDptName']);
                $values= [
                    WriterEntityFactory::createCell($aValue['FTCrdCode']),
                    WriterEntityFactory::createCell($tRPC14TBCardTypeName[1]),
                    WriterEntityFactory::createCell($aExplodeCrdHolderID[1]),
                    WriterEntityFactory::createCell($aValue['FTCrdName']),
                    WriterEntityFactory::createCell($tRPC14TBDptName[1]),
                    WriterEntityFactory::createCell($aValue['FTTxnDocNoRef']),
                    WriterEntityFactory::createCell($aValue['FTUsrName']),
                    WriterEntityFactory::createCell($aValue['FDTxnDocDate']),
                    WriterEntityFactory::createCell($tCrdStaActive),
                    WriterEntityFactory::createCell(FCNnGetNumeric($aValue['FCTxnCrdValue'])),
                    WriterEntityFactory::createCell(FCNnGetNumeric($aValue['FCTxnValue'])),
                    WriterEntityFactory::createCell(FCNnGetNumeric($aValue['FCTxnValAftTrans']))
                ];
                ...
                if(($nKey+1)==FCNnHSizeOf($aDataReport['raItems'])){ //SumFooter
                    $aDataSumFooterReport = $this->mRptTopUp->FSaMRPTCRDGetDataRptTopUpSum($aDataWhere);
                    ...
                    $values= [
                        ...
                        WriterEntityFactory::createCell(null),
                        WriterEntityFactory::createCell(null),
                        WriterEntityFactory::createCell(FCNnGetNumeric($aDataSumFooterReport[0]['FCTxnCrdValue'])),
                        WriterEntityFactory::createCell(FCNnGetNumeric($aDataSumFooterReport[0]['FCTxnValue'])),
                        WriterEntityFactory::createCell(FCNnGetNumeric($aDataSumFooterReport[0]['FCTxnValAftTrans'])),
                    ];
