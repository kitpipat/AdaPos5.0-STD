        ...
        if(isset($aDataReport['raItems']) && !empty($aDataReport['raItems'])) {
            foreach ($aDataReport['raItems'] as $nKey => $aValue) {
                ...
                $values= [
                    ...
                    WriterEntityFactory::createCell(null),
                    WriterEntityFactory::createCell(number_format($aValue['FCTxnValue'],$nOptDecimalShow),$oStyle),
                    WriterEntityFactory::createCell(null),
                ...
                if(($nKey+1)==FCNnHSizeOf($aDataReport['raItems'])){ //SumFooter
                    ...
                    $values= [
                        ...
                        WriterEntityFactory::createCell(null),
                        WriterEntityFactory::createCell(null),
                        WriterEntityFactory::createCell(number_format($aDataSumFooterReport[0]['FCTxnValueSum'],$nOptDecimalShow),$oStyle),
                        WriterEntityFactory::createCell(null),
                        WriterEntityFactory::createCell(null),
                        WriterEntityFactory::createCell(null),
                    ];
