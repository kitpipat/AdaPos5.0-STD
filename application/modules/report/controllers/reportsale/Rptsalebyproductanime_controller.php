...
class Rptsalebyproductanime_controller extends MX_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->load->model('report/reportsale/Rptsalebyproductanime_model');
    ...
    private function init()
    {
        $this->aText = [
            ...
            // TitleReport
            'tTitleReport' => language('report/report/report', 'tRptSaleByProductAnimeTitle'),
    ...
    public function index()
    {
        if (!empty($this->tRptExportType) && !empty($this->tRptCode)) {
            ...
            $this->Rptsalebyproductanime_model->FSnMExecStoreReport($this->aRptFilter);
    ...
    public function FSvCCallRptViewBeforePrint()
    {
        ...
        $aDataReport = $this->Rptsalebyproductanime_model->FSaMGetDataReport($aDataWhereRpt);
        ...
        $tRptView = JCNoHLoadViewAdvanceTable('report/datasources/rptsalebyproductanime', 'wRptSaleByProductAnimeHtml', $aDataViewRpt);
    ...
    public function FSoCChkDataReportInTableTemp()
    {
        try {
            ...
            $nDataCountPage = $this->Rptsalebyproductanime_model->FSnMCountRowInTemp($aDataCountData);
            $aResponse = array(
    ...
    public function FSvCCallRptRenderExcel()
    {
        ...
        $aCells = [
            WriterEntityFactory::createCell($this->aText['tRptBranchCode']),
            WriterEntityFactory::createCell($this->aText['tRptBranchName']),
            WriterEntityFactory::createCell($this->aText['tRptSaleByProductAnimeBarCode']),
            WriterEntityFactory::createCell($this->aText['tRptPdtName']),
            WriterEntityFactory::createCell($this->aText['tRptPdtGrp']),
            WriterEntityFactory::createCell($this->aText['tRptSaleByProductAnimeBrand']),
            WriterEntityFactory::createCell($this->aText['tRptQty']),
            WriterEntityFactory::createCell($this->aText['tRptSaleByProductAnimeBalance']),
            WriterEntityFactory::createCell($this->aText['tRptSales']),
            WriterEntityFactory::createCell($this->aText['tRptSaleByProductAnimeSetPrice']),
            WriterEntityFactory::createCell($this->aText['tRptGrand']),
        ];
        ...
        if (isset($aDataReport['aRptData']) && !empty($aDataReport['aRptData'])) {
            foreach ($aDataReport['aRptData'] as $nKey => $aValue) {
                ...
                $values = [
                    ...
                    WriterEntityFactory::createCell(($aValue['FTPbnName'] == "" ? "-" : $aValue['FTPbnName'])),
                    WriterEntityFactory::createCell(FCNnGetNumeric($aValue['FCXsdQtyAll'])),
                    WriterEntityFactory::createCell(FCNnGetNumeric($aValue['FCStkQty'])),
                    WriterEntityFactory::createCell(FCNnGetNumeric($aValue['FCSdtNetSale'])),
                    WriterEntityFactory::createCell(FCNnGetNumeric($aValue['FCPgdPriceRet'])),
                    WriterEntityFactory::createCell(FCNnGetNumeric($aValue['FCSdtNetAmt'])),
                ];
                ...
                if (($nKey + 1) == FCNnHSizeOf($aDataReport['aRptData'])) { //SumFooter
                    $values = [
                        ...
                        WriterEntityFactory::createCell(FCNnGetNumeric($aValue['FCSdtNetSale_Footer'])),
                        WriterEntityFactory::createCell(FCNnGetNumeric($aValue['FCPgdPriceRet_Footer'])),
                        WriterEntityFactory::createCell(FCNnGetNumeric($aValue['FCSdtNetAmt_Footer'])),
                    ];
