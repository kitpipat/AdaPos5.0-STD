...
date_default_timezone_set("Asia/Bangkok");
class Rptdepositdailybypos_controller extends MX_Controller
{
    /**
     * ภาษา
     * @var array
    ...
    public function __construct(){
        ...
        $this->load->model('report/rptdepositdailybypos/Rptdepositdailybypos_model');
    ...
    private function init(){
        $this->aText = [
            ...
            'tTitleReport' => language('report/report/report', 'tRptTitleDepositDaily'),
            ...
            'tRptBCH'               => language('report/report/report', 'tRptTaxSaleBanch'),
    ...
    public function index(){
        if (!empty($this->tRptCode) && !empty($this->tRptExportType)) {
            ...
            $this->Rptdepositdailybypos_model->FSnMExecStoreReport($this->aRptFilter);
    ...
    public function FSvCCallRptViewBeforePrint(){
        try {
            ...
            //Get Data
            $aDataReport = $this->Rptdepositdailybypos_model->FSaMGetDataReport($aDataReportParams);
            ...
            $tRptView = JCNoHLoadViewAdvanceTable('report/datasources/rptdepositdailybypos', 'wRptDepositDailyByPosHtml', $aDataViewRptParams);
    ...
    public function FSvCCallRptViewBeforePrintClickPage(){
        ...
        //Get Data
        $aDataReport = $this->Rptdepositdailybypos_model->FSaMGetDataReport($aDataWhere, $aDataFilter);
    ...
    public function FSoCChkDataReportInTableTemp(){
        try {
            ...
            $nDataCountPage = $this->Rptdepositdailybypos_model->FSnMCountRowInTemp($aDataCountData);
    ...
    public function FSvCCallRptRenderExcel(){
        ...
        $aCells = [
            WriterEntityFactory::createCell(language('report/report/report', 'tRptTaxSaleBanch')),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(language('report/report/report', 'tRptSalePos')),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(null),
        ...
        if (isset($aDataReport['aRptData']) && !empty($aDataReport['aRptData'])) {
            ...
            foreach ($aDataReport['aRptData'] as $nKey => $aValue) {
                ...
                $values = [
                    ...
                    WriterEntityFactory::createCell(null),
                    WriterEntityFactory::createCell(null),
                    WriterEntityFactory::createCell('(' . $aValue['FTPosCode'] .')' . $aValue['rtPosName']),
                    WriterEntityFactory::createCell(null),
                    WriterEntityFactory::createCell(null),

                    WriterEntityFactory::createCell(date_format(date_create($aValue['FDXshDocDate']),'d/m/Y')),
                    WriterEntityFactory::createCell(null),
    ...
    public function FSoCCallRptRenderFooterExcel(){
        ...
        // สาขา เลือก
        if (!empty($this->aRptFilter['tBchCodeFrom'])) {
            $tBchSelectText = ($this->aRptFilter['bBchStaSelectAll']) ? $this->aText['tRptAll'] : $this->aRptFilter['tBchNameFrom'];
            $aCells = [
                WriterEntityFactory::createCell($this->aText['tRptBCH'] . ' : ' . $tBchSelectText),
                WriterEntityFactory::createCell(null),
                WriterEntityFactory::createCell(null),
                WriterEntityFactory::createCell(null),
                WriterEntityFactory::createCell(null),
        ...
        // เครื่องจุดขาย (Pos) เลือก
        if (!empty($this->aRptFilter['tRptPosCodeFrom'])) {
            $tPosSelectText = ($this->aRptFilter['bPosStaSelectAll']) ? $this->aText['tRptAll'] : $this->aRptFilter['tRptPosNameFrom'];
            $aCells = [
                WriterEntityFactory::createCell($this->aText['tRptSalePos'] . ' : ' . $tPosSelectText),
                WriterEntityFactory::createCell(null),
                WriterEntityFactory::createCell(null),
                WriterEntityFactory::createCell(null),
                WriterEntityFactory::createCell(null),
