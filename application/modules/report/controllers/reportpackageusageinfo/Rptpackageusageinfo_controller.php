...
class Rptpackageusageinfo_controller extends MX_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->load->model('report/reportpackageusageinfo/Rptpackageusageinfo_model');
    ...
    private function init()
    {
        $this->aText = [
            // Title
            'tTitleReport' => language('report/report/report', 'tRptTitlePackUsage'),
            ...
            'tRptCouponFrom'   => language('report/report/report', 'tRptCouponFrom'),
            'tRptCouponTo'     => language('report/report/report', 'tRptCouponTo'),
        ...
        $this->aRptFilter = [
            ...
            'tCouponCodeTo'     => (empty($this->input->post('oetRptCouponCodeTo'))) ? '' : $this->input->post('oetRptCouponCodeTo'),
            'tCouponNameTo'     => (empty($this->input->post('oetRptCouponNameTo'))) ? '' : $this->input->post('oetRptCouponNameTo'),
    ...
    public function index()
    {
        ...
        if (!empty($this->tRptExportType) && !empty($this->tRptCode)) {
            ...
            $this->Rptpackageusageinfo_model->FSnMExecStoreReport($this->aRptFilter);
    ...
    public function FSvCCallRptViewBeforePrint($paDataSwitchCase)
    {
        ...
        $aDataReport = $this->Rptpackageusageinfo_model->FSaMGetDataReport($aDataWhereRpt);
    ...
    public function FSoCChkDataReportInTableTemp($paDataSwitchCase)
    {
        try {
            ...
            $nDataCountPage = $this->Rptpackageusageinfo_model->FSnMCountDataReportAll($aDataCountData);
    ...
    public function FSvCCallRptRenderExcel()
    {
        ...
        $oStyleColums = (new StyleBuilder())
            ...
            ->build();
        $aCells = [
            WriterEntityFactory::createCell(language('report/report/report', 'tRptPKUCopCode')),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(language('report/report/report', 'tRptPKUCopname')),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(language('report/report/report', 'tRptPKUPos')),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(language('report/report/report', 'tRptBillNo')),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(language('report/report/report', 'tRptPKUTypeName')),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(language('report/report/report', 'tRPCOperator')),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(language('report/report/report', 'tRPC1TBCardTxnDocDate')),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(language('report/report/report', 'tRptPKUValues')),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(language('report/report/report', 'tRptPKUTotalVal')),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(language('report/report/report', 'tRptPKUActive')),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(language('report/report/report', 'tRptPKURemaining')),
            WriterEntityFactory::createCell(null),
        ];
        ...
        if (isset($aDataReport['aRptData']) && !empty($aDataReport['aRptData'])) {
            ...
            foreach ($aDataReport['aRptData'] as $nKey => $aValue) {
                ...
                $values = [
                    WriterEntityFactory::createCell($aValue['FTCpnNo']),
                    WriterEntityFactory::createCell(null),
                    WriterEntityFactory::createCell($aValue['FTCpnName']),
                    WriterEntityFactory::createCell(null),
                    WriterEntityFactory::createCell($aValue['FTPosName']),
                    WriterEntityFactory::createCell(null),
                    WriterEntityFactory::createCell($aValue['FTXshDocNo']),
                    WriterEntityFactory::createCell(null),
                    WriterEntityFactory::createCell($aValue['FTXshDocType']),
                    WriterEntityFactory::createCell(null),
                    WriterEntityFactory::createCell($aValue['FTUsrName']),
                    WriterEntityFactory::createCell(null),
                    WriterEntityFactory::createCell(date("Y-m-d H:i:s", strtotime($aValue["FDXshDocDate"]))),
                    WriterEntityFactory::createCell(null),
                    WriterEntityFactory::createCell($tCpnAmt),
                    WriterEntityFactory::createCell(null),
                    WriterEntityFactory::createCell($tCpnAmtTotal),
                    WriterEntityFactory::createCell(null),
                    WriterEntityFactory::createCell($tCpnQtyUse),
                    WriterEntityFactory::createCell(null),
                    WriterEntityFactory::createCell($tCpnQtyLeft),
                    WriterEntityFactory::createCell(null),
                ];
                ...
                if (($nKey + 1) == count($aDataReport['aRptData'])) { //SumFooter
                    ...
                    $nFCCpnAmtAmt_Footer = $aValue["FCCpnAmtAmt_Footer"];
                    $nFCCpnAmtTatal_Footer = $aValue["FCCpnAmtTatal_Footer"];
                    $nFCCpnQtyUse_Footer = $aValue["FCCpnQtyUse_Footer"];
                    $nFCCpnQtyLeft_Footer = $aValue["FCCpnQtyLeft_Footer"];
                    $values = [
