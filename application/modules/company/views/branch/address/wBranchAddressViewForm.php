                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" rows="2" maxlength="255" id="oetBranchAddressV2Desc1" name="oetBranchAddressV2Desc1"><?php echo @$tFTAddV2Desc1;?></textarea>
                        </div>
                        <div class="form-group">
                            <label class="xCNLabelFrm"><?php echo language('company/branch/branch','tBCHAddV2Desc2');?></label>
                            <textarea class="form-control" rows="2" maxlength="255" id="oetBranchAddressV2Desc2" name="oetBranchAddressV2Desc2"><?php echo @$tFTAddV2Desc2;?></textarea>
                        </div>
                        <div class="form-group">
                        ...
                        <div  class="form-group">
                            ...
                            <textarea class="form-control" rows="4" maxlength="200" id="oetBranchAddressRmk" name="oetBranchAddressRmk"><?php echo @$tFTAddRmk;?></textarea>
                        </div>
                    </div>
