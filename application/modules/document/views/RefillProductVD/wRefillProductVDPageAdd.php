                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="oetRVDWahTransferRefCode" id="oetRVDWahTransferRefCode" class="form-control xCNApvOrCanCelDisabled" maxlength="20"value="<?= $tTransferRefCode ?>" type="text" placeholder="<?= language('document/RefillProductVD/RefillProductVD', 'tRVDWahTransferRefCode') ?>">
                                </div>

                                <!--เลขที่ใบขนส่ง-->
                                <div class="form-group">
                                    <label class="xCNLabelFrm"><?= language('document/RefillProductVD/RefillProductVD', 'tRVDWahTransferRefIDCode'); ?></label>
                                    <input name="oetRVDWahTransferRefIDCode" id="oetRVDWahTransferRefIDCode" class="form-control xCNApvOrCanCelDisabled" maxlength="20" value="<?= $tTransferRefIDCode ?>" type="text" placeholder="<?= language('document/RefillProductVD/RefillProductVD', 'tRVDWahTransferRefIDCode') ?>">
                                </div>
