                ...
                <div id="odvTWODataConditionREF" class="xCNMenuPanelData panel-collapse collapse" role="tabpanel">
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control xCNApvOrCanCelDisabled" id="oetTWORefExtDoc" name="oetTWORefExtDoc" maxlength="20" value="<?= $tTWORefExt ?>">
                        </div>
                        <!-- วันที่เอกสารภายนอก -->
                        <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control xCNInputWOthoutSpc xCNApvOrCanCelDisabled" maxlength="20" id="oetTWOTransportRefTnfID" name="oetTWOTransportRefTnfID" value="<?= $tTWOXthRefTnfID ?>">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control xCNInputWOthoutSpc xCNApvOrCanCelDisabled" maxlength="50" id="oetTWOTransportRefVehID" name="oetTWOTransportRefVehID" value="<?= $tTWOXthRefVehID ?>">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control xCNInputWOthoutSpc xCNApvOrCanCelDisabled" maxlength="30" id="oetTWOTransportQtyAndTypeUnit" name="oetTWOTransportQtyAndTypeUnit" value="<?= $tTWOXthQtyAndTypeUnit ?>">
                                </div>
                            </div>
                        </div>
