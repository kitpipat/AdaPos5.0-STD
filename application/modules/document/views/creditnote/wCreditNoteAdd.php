                ...
                <div id="odvCreditNoteRefInfoPanel" class="xCNMenuPanelData panel-collapse collapse" role="tabpanel">
                    <div class="panel-body xCNPDModlue">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" id="oetCreditNoteXphRefExt" name="oetCreditNoteXphRefExt" maxlength="20" value="<?php echo $tRefExt; ?>" <?php echo $bIsApvOrCancel ? 'disabled' : '' ?>>
                        </div>
                        <!-- อ้างอิงเอกสารภายนอก -->
