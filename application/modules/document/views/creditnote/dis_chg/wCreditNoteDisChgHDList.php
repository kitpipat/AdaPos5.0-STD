                    ...
                    <?php if($aDataList['rtCode'] == 1 ):?>
                        <?php foreach($aDataList['raItems'] AS $nKey => $aValue): ?>
                            <tr class="xWCreditNoteDisChgTrTag">
                                ...
                                <td nowrap class="text-right"><label class="xWCreditNoteDisChgValue"></label></td>
                                <td nowrap class="text-right"><label class="xWCreditNoteDisChgAfterDisChg"><?php echo $aValue['FNRowID']; ?></label></td>
                                ...
                                <td nowrap style="padding-left: 5px !important;">
                                    <div class="form-group" style="margin-bottom: 0px !important;">
                                        <input 
                                            ...
                                            onchange="JSxCreditNoteCalcDisChg(this); JCNxCreditNoteDisChgSetCreateAt(this)"
                        ...
                        <?php endforeach;?>
                    <?php else:?>
                        <tr id="otrCreditNoteDisChgHDNotFound"><td class="text-center xCNTextDetail2" colspan='100%'><?php echo language('common/main/main','tCMNNotFoundData')?></td></tr>
                    <?php endif;?>
...
<?php if($aDataList['rnAllPage'] > 1) : ?>
    <div class="row" id="odvCreditNoteDisChgHDList">
        ...
        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
            <div class="xWPage btn-toolbar pull-right">
                ...
                <button onclick="JSvCreditNoteDisChgHDClickPage('previous')" class="btn btn-white btn-sm" <?php echo $tDisabledLeft ?>>
                ...
                <?php for($i=max($nPage-2, 1); $i<=max(0, min($aDataList['rnAllPage'],$nPage+2)); $i++){?>
                    ...
                    ?>
                    <button onclick="JSvCreditNoteDisChgHDClickPage('<?php echo $i?>')" type="button" class="btn xCNBTNNumPagenation <?php echo $tActive ?>" <?php echo $tDisPageNumber ?>><?php echo $i?></button>
                <?php } ?>

                <?php if($nPage >= $aDataList['rnAllPage']){  $tDisabledRight = 'disabled'; }else{  $tDisabledRight = '-';  } ?>
                <button onclick="JSvCreditNoteDisChgHDClickPage('next')" class="btn btn-white btn-sm" <?php echo $tDisabledRight ?>>
