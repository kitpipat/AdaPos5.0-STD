                    ...
                    <div class="form-group">
                        ...
                        ?>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" maxlength="100" id="oetPhwName" name="oetPhwName" placeholder="<?= language('pos/salemachine/salemachine', 'tPOSNameDevice') ?>" value="<?= $tPhwName ?>" data-validate-required="<?= language('pos/salemachine/salemachine', 'tPOSValidName') ?>">
                            </div>
                            ...
                            <div class="form-group" id="odvReferConn">
                                ...
                                <div id="odvTypeTCP">
                                    ...
                                    <input type="text" class="form-control" maxlength="255" id="oetPhwConRef" name="oetPhwConRef" value="<?= $tConnRef ?>" placeholder='xxx.xxx.xx' data-validate="<?= language('pos/salemachine/salemachine', 'tPOSValidName') ?>">
                                </div>
                                ...
                                <div id="odvTypeBluetooth">
                                    ...
                                    <input type="text" class="form-control" maxlength="255" id="oetBluetooth" name="oetBluetooth" value="<?= $tConnRef ?>" placeholder='Bluetooth name'>
                                </div>
