...
<div class="row">
    ...
    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
        <div class="xWPIPageDataTable btn-toolbar pull-right">
            ...
            <button onclick="JSxPDTPCPClickPageList('previous')" class="btn btn-white btn-sm" <?php echo $tDisabledLeft ?>>
            ...
            <?php 
                ...
                ?>
            <button onclick="JSxPDTPCPClickPageList('<?php echo $i?>')" type="button"
                class="btn xCNBTNNumPagenation <?php echo $tActive ?>"
                <?php echo $tDisPageNumber ?>><?php echo $i?></button>
            <?php } ?>

            <?php if($nPage >= $aDataList['rnAllPage']){  $tDisabledRight = 'disabled'; }else{  $tDisabledRight = '-';  } ?>
            <button onclick="JSxPDTPCPClickPageList('next')" class="btn btn-white btn-sm" <?php echo $tDisabledRight ?>>
