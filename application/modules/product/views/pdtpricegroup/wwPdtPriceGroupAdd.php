            ...
            <div class="row">
                <div class="col-xs-12 col-md-5 col-lg-5"> <!-- เปลี่ยน Col Class -->
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" maxlength="200" id="oetPplName" name="oetPplName" value="<?=$tPplName?>" 
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" maxlength="200" rows="4" id="otaPplRmk" name="otaPplRmk"><?=$tPplRmk?></textarea>
                    </div>
                </div>
            </div>
        </div>
