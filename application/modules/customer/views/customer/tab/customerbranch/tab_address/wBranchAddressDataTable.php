    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
        <div class="table-responsive">
            <table id="otbBranchAddressTableList" class="table table-striped">
                <thead>
                    <tr>
                        <th nowarp class="text-center xCNTextBold" width="5%"><?php echo language('company/branch/branch','tBCHAddressTblHeadNo');?></th>
                        <th nowarp class="text-center xCNTextBold" width="35%"><?php echo language('company/branch/branch','tBCHAddressTblHeadAddrName');?></th>
                        <th nowarp class="text-center xCNTextBold" width="20%"><?= language('customer/customer/customer','tCSTBranchRegNo')?></th>
                        <th nowarp class="text-center xCNTextBold" width="20%"><?php echo language('company/branch/branch','tBCHAddressTblHeadAddrRmk');?></th>
                        <th nowarp class="text-center xCNTextBold" width="5%"><?php echo language('company/branch/branch','tBCHAddressTblHeadAddrEdit')?></th>
                        <th nowarp class="text-center xCNTextBold" width="5%"><?php echo language('company/branch/branch','tBCHAddressTblHeadAddrDelete')?></th>
                    </tr>
                </thead>
                <tbody>
                    <?php if(isset($aCstBchDataAddress) && !empty($aCstBchDataAddress)):?>
                        <?php foreach($aCstBchDataAddress AS $nNum => $aDataAddress):?>
                            <tr 
                            ...
                            >
                                ...
                                <td nowarp class="text-left"><?php echo $aDataAddress['FTCbrRegNo'];?></td>
            ...
            setTimeout(function () {
                if(poElement.getAttribute("data-dblclick") == 1) {
                    ...
                    if(typeof(nStaSession) !== 'undefined' && nStaSession == 1){
                        ...
                        JSaCstBchAddrDelete(oBranchAddressData);
                    }else{
                ...
                if(poElement.getAttribute("data-dblclick") == 1) {
                    ...
                    if(typeof(nStaSession) !== 'undefined' && nStaSession == 1){
                        let oBranchAddressData    = {
                            ...
                            'FNAddSeqNo'    : $(poElement).parents('.xWBranchAddress').data('addseqno'),
                            'FTCstCode'    : $('#oetCstCode').val() ,
                            'FTCbrRefBch'    : $('#oetCstBchCode_InTab').val() ,
                        }
                        JSvCstBchAddrCallPageEdit(oBranchAddressData);
                    }else{
                        JCNxShowMsgSessionExpired();
                    }
                }
